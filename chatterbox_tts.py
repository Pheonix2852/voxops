...
# modal run chatterbox_tts.py --prompt "Hello from Chatterbox [chuckle]." --voice-key "voices/system<voice id>"

#Use this to test CURL:
# curl.exe -X POST "endpoint url" \
...
R2_BUCKET_NAME = "voxops-voice"
R2_ACCOUNT_ID = "372f1a072a5c57f33a17b0b3718504da"
R2_MOUNT_PATH = "/r2"
